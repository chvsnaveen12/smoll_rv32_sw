...
carray-fdt_serial_drivers-$(CONFIG_FDT_SERIAL_SMOLLUART) += fdt_serial_smolluart
libsbiutils-objs-$(CONFIG_FDT_SERIAL_SMOLLUART) += serial/fdt_serial_smolluart.o
libsbiutils-objs-$(CONFIG_SERIAL_SMOLLUART) += serial/smolluart.o
