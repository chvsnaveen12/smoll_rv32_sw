...
struct sbi_trap_context *sbi_trap_handler(struct sbi_trap_context *tcntx)
{
	...
	// 	: : "r"((tcntx->regs.mepc >> 28) & 0xf), "r"((tcntx->regs.mepc >> 24) & 0xf), "r"((tcntx->regs.mepc >> 20) & 0xf), "r"((tcntx->regs.mepc >> 16) & 0xf), "r"((tcntx->regs.mepc >> 12) & 0xf), "r"((tcntx->regs.mepc >> 8) & 0xf), "r"((tcntx->regs.mepc >> 4) & 0xf), "r"((tcntx->regs.mepc >> 0) & 0xf) :  "t5", "t6");
