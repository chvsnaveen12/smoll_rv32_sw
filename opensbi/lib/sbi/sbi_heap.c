...
out:
	...
	// 	: : "r"(((int)ret >> 28) & 0xf), "r"(((int)ret >> 24) & 0xf), "r"(((int)ret >> 20) & 0xf), "r"(((int)ret >> 16) & 0xf), "r"(((int)ret >> 12) & 0xf), "r"(((int)ret >> 8) & 0xf), "r"(((int)ret >> 4) & 0xf), "r"(((int)ret >> 0) & 0xf) :  "t5", "t6");
